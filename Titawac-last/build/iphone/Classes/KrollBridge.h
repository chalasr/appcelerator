...
@interface Titanium_wacObject : KrollCoverageObject {
#else
@interface Titanium_wacObject : KrollObject {
#endif
@private
...
extern NSString * Titanium_wac_wac$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Titanium_wacObject *_titanium_wac;
    KrollObject* console;
	BOOL shutdown;
