...
/**
 The base class for all Titanium_wac modules
 */
...
/**
 Titanium_wac Platform calls this method on startup.
 */
-(void)startup;

/**
 Titanium_wac Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Titanium_wac Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Titanium_wac Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Titanium_wac Platform calls this method on resume.
 @param sender The sender of the event.
 */
