...
// in simulator we redefine to format for Titanium_wac Developer console
...
{\
	NSString * exceptionName = [@"org.titanium_wac." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titanium_wac";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITitanium_wacNativeItemNone = -1, 
	UITitanium_wacNativeItemSpinner = -2,
	UITitanium_wacNativeItemProgressBar = -3,
	
	UITitanium_wacNativeItemSlider = -4,
	UITitanium_wacNativeItemSwitch = -5,
	UITitanium_wacNativeItemMultiButton = -6,
	UITitanium_wacNativeItemSegmented = -7,
	
	UITitanium_wacNativeItemTextView = -8,
	UITitanium_wacNativeItemTextField = -9,
	UITitanium_wacNativeItemSearchBar = -10,
	
	UITitanium_wacNativeItemPicker = -11,
	UITitanium_wacNativeItemDatePicker = -12,
	
	UITitanium_wacNativeItemInfoLight = -13,
	UITitanium_wacNativeItemInfoDark = -14,
	
	UITitanium_wacNativeItemDisclosure = -15,
	
	UITitanium_wacNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Titanium_wac instances of
