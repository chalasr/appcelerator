...
//Rare exceptions to indicate a bug in the _titanium_wac code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Titanium_wac proxies.
 */
