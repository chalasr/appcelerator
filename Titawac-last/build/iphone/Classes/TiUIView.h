...
/**
 Base class for all Titanium_wac views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Titanium_wac view hierarchy (such as wrapped iOS UIViews) was touched.
