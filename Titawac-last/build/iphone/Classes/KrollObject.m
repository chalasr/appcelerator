...
//@interface Titanium_wacObject : NSObject
//@end

@interface Titanium_wacObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Titanium_wacObject class]])
		{
			for (NSString *key in [[(Titanium_wacObject*)o modules] allKeys])
			{
